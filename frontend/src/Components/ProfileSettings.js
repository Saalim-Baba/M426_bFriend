...
const ProfileSettings = () => {
    ...
    return (
        <div className="flex-1">
            <div className="mx-auto p-6 bg-white shadow-md rounded-lg m-10" style={{ width: "45%" }}>
                <form>
                    ...
                    <div className="flex flex-wrap m-2">
                        {formData.hobbies.map((element, index) => (
                            <div key={index}
                                 className="px-4 py-2 bg-gray-100 hover:bg-gray-200     border border-gray-300 rounded shadow cursor-pointer m-1 text-sm overflow-hidden"
